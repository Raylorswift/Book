<template>
  <div class="user">
    <!-- {{multipleSelection}} -->
    <div class="btn">
      <el-button size='mini' @click='toAddUser' plain>新增</el-button>
    <!-- <el-button type='success' @click='batchDelete'>批量删除</el-button> -->
    </div>
    
    <el-table size='mini' :data="users" style="width: 100%" :border='true' @selection-change="handleSelectionChange" v-loading='loading'>
      <!-- <el-table-column
        type="selection"
        width="55">
      </el-table-column> -->
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      loadAllUsers(){
        axios({
          baseURL:'http://47.106.188.95:8099',
